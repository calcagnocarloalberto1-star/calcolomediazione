        ...
        <section aria-labelledby="progetto-title" className="bg-card border-[2px] border-foreground shadow-[4px_4px_0px_0px] shadow-foreground/20 p-6 sm:p-8 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <FeatureCard
              icon={Brain}
              title="Analisi AI"
              description="Genera un'analisi AI del caso a partire dai documenti del fascicolo. Le analisi restano consultabili, esportabili e cancellabili con il relativo token."
        ...
        <section aria-labelledby="missione-title" className="bg-card border-[2px] border-foreground shadow-[4px_4px_0px_0px] shadow-foreground/20 p-6 sm:p-8">
          ...
          <div className="space-y-3 text-sm leading-relaxed opacity-90">
            ...
            <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <li><strong>Innovazione responsabile:</strong> attivare le funzionalità AI solo dopo una valutazione d'impatto privacy documentata (DPIA) e un rischio residuo esplicitamente accettato dal titolare</li>
