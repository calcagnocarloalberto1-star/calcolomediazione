        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-0">
              ...
              <li><FooterLink href="/antiriciclaggio-guida">Antiriciclaggio in Mediazione: Guida agli Obblighi</FooterLink></li>
              <li><FooterLink href="/trasferimento-immobiliare-mediazione">Trasferimento Immobiliare in Mediazione</FooterLink></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-0">
              ...
              <li><FooterLink href="/analisi-caso-ai">Analisi AI del caso</FooterLink></li>
