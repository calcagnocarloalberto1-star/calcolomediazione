...
const PAGE_SOURCES: Record<string, string[]> = {
  ...
  "/antiriciclaggio-guida": ["client/src/pages/AntiriciclaggioGuida.tsx", "client/public/antiriciclaggio-guida.html"],
  ...
  "/procura-sostanziale-mediazione": ["client/src/pages/ProcuraSostanzialeMediazione.tsx"],
  ...
  "/assegno-mantenimento-divorzile-calcolo": ["client/src/pages/AssegnoMantenimentoDivorzileCalcolo.tsx"],
};
