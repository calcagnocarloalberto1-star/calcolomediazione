...
const SEO_PAGES: Record<string, { title: string; description: string }> = {
  "/": { title: "CalcoloMediazione - Calcolatore Indennit\u00e0 Mediazione Civile", description: "Piattaforma professionale per il calcolo delle indennit\u00e0 di mediazione D.M. 150/2023. Analisi AI del caso, confronto costi primo grado, appello e cassazione, stima CTU, esenzione prima casa, verifica congruità valore catastale, generatore procura." },
