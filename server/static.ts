...
const SEO_PAGES: Record<string, { title: string; description: string }> = {
  "/": { title: "CalcoloMediazione \u2014 Calcolatore Indennit\u00e0 Mediazione Civile e Strumenti ADR", description: "Piattaforma gratuita per avvocati e mediatori: calcolatore indennit\u00e0 D.M. 150/2023, confronto costi, costi notarili, credito d'imposta, generatori di documenti e Analisi AI del caso." },
  ...
  "/analisi-caso-ai": { title: "Analisi AI del Caso di Mediazione \u2014 Storico e Nuova Analisi", description: "Genera un'analisi AI del caso di mediazione a partire dai documenti del fascicolo, con chat per approfondirla. Le analisi gi\u00e0 create restano consultabili." },
  ...
  "/antiriciclaggio": { title: "Antiriciclaggio in Mediazione \u2014 Strumento manuale locale e modelli", description: "Strumento locale per la compilazione manuale dei modelli antiriciclaggio, con assistente AI opzionale sui documenti. Ruoli e obblighi vanno verificati nel caso concreto." },
