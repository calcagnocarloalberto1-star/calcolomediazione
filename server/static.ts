...
const SEO_PAGES: Record<string, { title: string; description: string }> = {
  "/": { title: "CalcoloMediazione \u2014 Calcolatore Indennit\u00e0 Mediazione Civile e Strumenti ADR", description: "Piattaforma gratuita per avvocati e mediatori: calcolatore indennit\u00e0 D.M. 150/2023, confronto costi, costi notarili, credito d'imposta e generatori di documenti. Le nuove analisi AI sono temporaneamente sospese." },
  ...
  "/analisi-caso-ai": { title: "Analisi AI del Caso di Mediazione \u2014 Funzione temporaneamente sospesa", description: "Le nuove analisi, il caricamento dei documenti e la chat AI sono temporaneamente sospesi durante il completamento delle verifiche privacy e contrattuali. Le analisi gi\u00e0 create restano consultabili." },
  ...
  "/mediazione-condominiale-delibera-assembleare": { title: "Mediazione Condominiale: Quando è Obbligatoria e Come Funziona la Delibera Assembleare", description: "Mediazione condominio e delibera assembleare dopo la Riforma Cartabia: quando è obbligatoria, cosa può fare l'amministratore senza delibera (art. 5-ter D.Lgs. 28/2010) e quando serve invece l'assemblea." },
  "/procura-sostanziale-mediazione": { title: "Procura Sostanziale per la Mediazione: Guida Aggiornata 2026 (Cass. 9608 e 10978)", description: "Procura sostanziale mediazione e procura speciale art. 8 D.Lgs. 28/2010: chi può rappresentare la parte, forma richiesta e la recente evoluzione della Cassazione (Cass. 9608/2026 e 10978/2026)." },
  "/mediazione-vs-causa-civile": { title: "Mediazione vs Causa Civile: la Vera Differenza di Costi e Tempi", description: "Mediazione o causa civile conviene? Confronto reale dei costi tra processo civile e mediazione: contributo unificato, compensi avvocato D.M. 55/2014, CTU, con un esempio di calcolo aggiornato." },
  "/credito-imposta-mediazione-domanda": { title: "Credito d'Imposta Mediazione: Come Richiederlo e Quanto Vale (Guida)", description: "Guida pratica al credito d'imposta per la mediazione civile: importi (fino a €1.118 per procedura), requisiti, scadenza del 31 marzo e procedura di domanda su lsg.giustizia.it." },
  "/gratuito-patrocinio-mediazione": { title: "Gratuito Patrocinio in Mediazione: Requisiti e Procedura (Guida)", description: "Gratuito patrocinio mediazione: chi può richiederlo, requisiti di reddito, come presentare l'istanza al COA e cosa succede se l'accordo non si raggiunge. Guida aggiornata artt. 15-bis/15-undecies D.Lgs. 28/2010." },
  "/maan-zopa-mediazione": { title: "MAAN e ZOPA in Mediazione: Come Chiudere l'Accordo con i Numeri", description: "MAAN e ZOPA applicate a un caso reale di mediazione: come calcolare la propria alternativa economica al giudizio e individuare la zona di possibile accordo per chiudere la trattativa." },
  "/assegno-mantenimento-divorzile-calcolo": { title: "Assegno di Mantenimento e Assegno Divorzile: Come si Calcolano (Guida)", description: "Assegno di mantenimento e assegno divorzile dopo Cass. SU 18287/2018: quali criteri considera il giudice, cosa cambia tra separazione e divorzio, e come funziona il mantenimento dei figli ex art. 337-ter c.c." },
  ...
  "/antiriciclaggio": { title: "Antiriciclaggio in Mediazione \u2014 Strumento manuale locale e modelli", description: "Strumento locale per la compilazione manuale dei modelli antiriciclaggio. L'assistente AI e il caricamento dei documenti sono temporaneamente sospesi; ruoli e obblighi vanno verificati nel caso concreto." },
