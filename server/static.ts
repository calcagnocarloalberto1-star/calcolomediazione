...
const SEO_PAGES: Record<string, { title: string; description: string }> = {
  ...
  "/faq": { title: "FAQ Mediazione Civile \u2014 Domande Frequenti D.M. 150/2023 e D.Lgs. 28/2010", description: "Le risposte alle domande pi\u00f9 frequenti sulla mediazione civile: indennit\u00e0, primo incontro, materie obbligatorie, agevolazioni fiscali art. 17, credito d'imposta, art. 5-quater (mediazione demandata)." },
