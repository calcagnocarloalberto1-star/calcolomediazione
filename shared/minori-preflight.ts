...
export const MINORS_NOTICE_TEXT =
    ...
    "finche non hai verificato la necessita del trattamento, la base giuridica, " +
    "l'informativa applicabile e la possibilita di eliminare nomi, recapiti, " +
...
export const MINORS_CONFIRMATION_LABELS: readonly string[] = [
    ...
    "Ho eliminato i dati non necessari rispetto alla finalita dell'analisi.",
    "Non ho inserito immagini o registrazioni del minore (vietate fino a una futura decisione separata).",
    "Non ho inserito recapiti diretti o altri identificativi del minore, salvo assoluta necessita documentata.",
...
export const MINORS_CATEGORIZATION_QUESTION =
    "La pratica contiene o puo contenere dati riferiti a persone di eta inferiore a 18 anni?";
